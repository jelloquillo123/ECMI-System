...
for($i=1;$i<11;$i++)
{
   $infosql=mysqli_query($db,"SELECT COUNT(a.parent_who) as 'all', 
(SELECT COUNT(parent_who) FROM parent WHERE parent_who = 'tatay') as 'tatay',
(SELECT COUNT(parent_who) FROM parent WHERE parent_who = 'nanay') as 'nanay',
(SELECT COUNT(parent_who) FROM parent WHERE parent_who = 'pareho') as 'pareho',
(SELECT COUNT(*) FROM parent a JOIN job b ON b.job_id = a.job_id WHERE b.job_based = 'LB') as 'LB',
(SELECT COUNT(*) FROM parent a JOIN job b ON b.job_id = a.job_id WHERE b.job_based = 'SB') as 'SB',
(SELECT COUNT(*) FROM parent a JOIN country b ON b.country_id = a.country_id WHERE b.cont_code = 'AS') as 'AS',
(SELECT COUNT(*) FROM parent a JOIN country b ON b.country_id = a.country_id WHERE b.cont_code = 'EU') as 'EU',
(SELECT COUNT(*) FROM parent a JOIN country b ON b.country_id = a.country_id WHERE b.cont_code = 'NA') as 'NA',
(SELECT COUNT(*) FROM parent a JOIN country b ON b.country_id = a.country_id WHERE b.cont_code = 'OC') as 'OC',
(SELECT COUNT(*) FROM parent a JOIN country b ON b.country_id = a.country_id WHERE b.cont_code NOT IN('AS', 'EU', 'NA', 'OC')) as 'OTHERS',
(SELECT COUNT(*) FROM parent WHERE a.parent_when = 1) as '1st',
(SELECT COUNT(*) FROM parent WHERE a.parent_when = 2) as '2nd',
(SELECT COUNT(*) FROM parent WHERE a.parent_when = 3) as '3rd',
(SELECT COUNT(*) FROM parent WHERE a.parent_when = 4) as '4th',
(SELECT COUNT(*) FROM parent WHERE a.parent_when = 5) as '5th'

FROM parent a
JOIN student b ON b.fam_id = a.parent_id
WHERE b.g_level = $i");
