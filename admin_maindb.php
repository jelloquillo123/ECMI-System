...
$admin_name_query = "SELECT admin.fname , admin.mname , admin.lname FROM admin JOIN account ON admin.account_id = account.account_id WHERE account.username = '$user_name'";
